...
if __name__ == '__main__':
    ...
    '''
    ax1.text(10, 25," L="+str(int(size)), ha='left', va='top', fontsize="20", bbox={'facecolor': 'white', 'pad': 10})
    ax2.text(3, 3,"L="+str(int(size/3)), fontsize="20", bbox={'facecolor': 'white', 'pad': 10})
    ax3.text(1, 1, "L="+str(int(size/9)), fontsize="20", bbox={'facecolor': 'white', 'pad': 10})
    ax4.text(12, size-20, "L="+str(int(size)), fontsize="20", bbox={'facecolor': 'white', 'pad': 10})
    ax5.text(6, size/2-8, "L="+str(int(size/2)), fontsize="20", bbox={'facecolor': 'white', 'pad': 10})
    ax6.text(2, size/4-2, "L="+str(int(size/4)), fontsize="20", bbox={'facecolor': 'white', 'pad': 10})
    '''
    ax1.set_xlim(0, size)
    ax1.set_ylim(0, size)
