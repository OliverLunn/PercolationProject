...
if __name__ == '__main__':
    ...
    #ax2.plot(probs, -1/np.log(probs), "k", label="$\\frac{-1}{ln(p)}$")
    ...
    ax1.set_xlabel("Occupation probabilty, p", fontsize="20")
    ax2.set_ylabel("$s_\zeta$", fontsize="20")
    ax2.set_xlabel("Occupation probabilty, p", fontsize="20")
